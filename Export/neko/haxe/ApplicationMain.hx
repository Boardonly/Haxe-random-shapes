...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Shapes", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Shapes", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Shapes";
		app.meta["name"] = "Shapes";
		app.meta["packageName"] = "com.sample.shapes";
